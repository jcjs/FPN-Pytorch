...
DATASETS = {
    ...
    'keypoints_coco_2017_train': {
        ...
        ANN_FN:
            _DATA_DIR + '/coco2017/annotations/person_keypoints_train2017.json'
    },
    'keypoints_coco_2017_val': {
        IM_DIR:
            _DATA_DIR + '/coco2017/val2017',
        ANN_FN:
            _DATA_DIR + '/coco2017/annotations/person_keypoints_val2017.json'
    },
    'keypoints_coco_2017_test': {
        IM_DIR:
            _DATA_DIR + '/coco2017/test2017',
        ANN_FN:
            _DATA_DIR + '/coco2017/annotations/image_info_test2017.json'
    },
    'voc_2007_trainval': {
        IM_DIR:
